...
This means that the user does not have to explicity state the resources that need to be used, but the user does still need to monitor relationships between objects to avoid memory leaks.
